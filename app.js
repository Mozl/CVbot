	...
	switch (action) {
		case 'detailed-experience':
			if (isDefined(contexts[0]) && contexts[0].name == 'experience-details' && contexts[0].parameters) {
				...
				if ('user_name' != '') {
					let emailContent = 'A new experience enquiry from ' + user_name + '.';

					sendEmail('New experience enquiry', emailContent);
				}
			}
			...
			let replies = [
				{
					...
					"title":"Experience",
					"payload":"Experience",
					"image_url":"https://www.irishtimes.com/polopoly_fs/1.1528765.1379281168!/image/image.jpg_gen/derivatives/box_620_330/image.jpg"
				},
				{
					"content_type":"text",
					"title":"Education",
...
function handleApiAiResponse(sender, response) {
	...
	if (isDefined(messages) && (messages.length == 1 && messages[0].type != 0 || messages.length > 1)) {
		...
		sendTextMessage(sender, "I'm not sure what you want. Can you be a bit more specific?");
